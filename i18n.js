...
const translations = {
    ...
    th: {
        ...
        nav: {
            ...
            contact: "ติดต่อ",
            blog: "บทความ",
            themeToggle: "เข้าสู่ความมืด"
        },
        // Hero section
        hero: {
            titles: [
                "รับประกัน Downtime 99.999%",
                "Packet ไปไหนวะ วิ่งตามเองละกันนะ",
                "พังแบบมืออาชีพตั้งแต่ 2025",
        ...
        status: {
            ...
            uptimeLabel: "Uptime (24 ชั่วโมงที่ผ่านมา)",
            uptimeValue: "ปัจจุบัน: 0.001%",
            packetLossLabel: "อัตราการเสียแพ็กเก็ต", 
            packetLossValue: "ปัจจุบัน: 99.999%"
        },
        // Pricing
        pricing: {
            title: "แผนราคา 💸",
        ...
        testimonials: {
            ...
            items: [
                ...
                {
                    text: "SLAZero เกินความคาดหวังของผมโดยการไม่มีความคาดหวังเลย",
                    author: "นักพัฒนาผิดหวัง"
                },
                {
                    text: "ในที่สุดก็มีบริการที่ซื่อสัตย์เรื่องความไร้ความสามารถ!",
                    author: "คนมองโลกในแง่ดีที่เปลี่ยนใจ"
                }
            ]
        },
        // Contact
        contact: {
            ...
            form: {
                ...
                emailLabel: "อีเมล (เราสัญญาว่าจะไม่ส่งสแปม... มาก)",
        ...
        // Footer
        footer: {
            tagline: "สร้างความผิดหวังให้ลูกค้าตั้งแต่ 2025",
            sections: {
                quickLinks: {
                    title: "ลิงค์ด่วน",
                    links: [
            ...
            disclaimer: "สงวนสิทธิ์ทุกประการ ข้อกำหนดอาจใช้บังคับ ไม่รับประกันผลลัพธ์",
            smallPrint: "ผลข้างเคียงอาจรวมถึงความหงุดหงิด ความสับสน และความรู้สึกผิดหวังอย่างล้นหลาม"
        },
        // Alerts
        alerts: {
    ...
    ja: {
        ...
        status: {
            ...
            uptimeLabel: "稼働時間（過去24時間）",
            uptimeValue: "現在: 0.001%",
            packetLossLabel: "パケット損失率",
            packetLossValue: "現在: 99.999%"
        },
        // Pricing
        pricing: {
            title: "料金プラン 💸",
        ...
        testimonials: {
            ...
            items: [
                ...
                {
                    text: "SLAZeroは期待を全く持たないことで期待を上回った",
                    author: "失望した開発者"
                },
                {
                    text: "ついに無能さについて正直なサービスが！",
                    author: "改心した楽観主義者"
                }
            ]
        },
        ...
        footer: {
            ...
            disclaimer: "全権利留保。条件が適用される場合があります。結果は保証されません。",
            smallPrint: "副作用には、イライラ、混乱、そして圧倒的な失望感が含まれる場合があります"
        },
        // Alerts
        alerts: {
